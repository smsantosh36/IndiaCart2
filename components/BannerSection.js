  ...
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-display text-2xl font-medium">Advertisement</h2>
        <Link
          href="/banners"
      ...
      <div className="relative group">
        {/*
          mobile: 2.5 visible (peek hint ke liye), tablet (md): 3 visible,
          desktop (lg): 4 visible. 5-8 banners hone par row apne aap
          horizontal slider ban jaati hai.
        */}
        <div
          ref={scrollRef}
        ...
        >
          {banners.map((banner) => (
            <div
              key={banner.id}
              className="flex-none snap-start w-[calc((100%-16px)/2.5)] md:w-[calc((100%-32px)/3)] lg:w-[calc((100%-48px)/4)]"
            >
