  ...
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-display text-2xl font-medium">Brands</h2>
        <Link
          href="/brands"
      ...
      <div className="relative group">
        {/*
          mobile: 2.5 visible (peek hint ke liye), tablet (md): 4 visible,
          desktop (lg): 6 visible. Isse zyada brands hon to row apne aap
        ...
        */}
        ...
        >
          {brands.map((brand) => (
            <div
              key={brand.id}
              className="flex-none snap-start w-[calc((100%-16px)/2.5)] md:w-[calc((100%-48px)/4)] lg:w-[calc((100%-80px)/6)]"
            >
